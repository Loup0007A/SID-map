...
import { DEFAULT_PLACE_ICONS } from '@/lib/icons';
    ...
    <div className="flex h-screen w-full flex-col overflow-hidden">
          ...
          return (
            ...
            >
              ...
              <text textAnchor="middle" dy={iconSize * 0.35} fontSize={iconSize} fill="#e7e5db">
                {p.icon || DEFAULT_PLACE_ICONS[p.type] || '📍'}
              </text>
              <text
                textAnchor="middle"
                dy={labelOffset}
      ...
      <MapLegend
        sections={[
          {
            title: 'Lieux',
            items: Object.entries(DEFAULT_PLACE_ICONS).map(([type, icon]) => ({
              icon,
              label: PLACE_LABELS[type as keyof typeof PLACE_LABELS]
            }))
          },
          {
            title: 'Zones',
