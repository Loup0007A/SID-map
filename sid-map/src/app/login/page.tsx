    ...
    <main className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="glass-strong overflow-hidden rounded-2xl">
          <div className="stamp-bar h-1.5 w-full" />
          <form onSubmit={handleSubmit} className="space-y-5 p-8">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full glass-input rounded-lg px-3 py-2 text-sm text-paper outline-none"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-accent w-full rounded-lg py-2.5 font-display text-xs uppercase tracking-widest2 text-paper transition disabled:opacity-50"
            >
